...
execute if data entity @s {billboard:"fixed"} at @s run tp 4fe002bb-0-0-0-1 ^ ^ ^0.1 ~ ~
execute if data entity @s {billboard:"fixed"} at @s run tp 4fe002bb-0-0-0-2 ^ ^ ^-0.1 ~ ~
...
execute if data entity @s {billboard:"center"} at @s rotated as @p run tp 4fe002bb-0-0-0-1 ^ ^ ^-0.1 ~ ~
execute if data entity @s {billboard:"center"} at @s rotated as @p facing ^ ^ ^-1 run tp 4fe002bb-0-0-0-2 ^ ^ ^-0.1 ~ ~
# 二分探査
execute as @p at @s anchored eyes positioned ^ ^ ^ rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^16 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^8 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^4 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^2 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^1 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^0.5 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^0.25 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^0.125 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^0.0625 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^0.03125 rotated as @e[tag=display_pos,limit=1,sort=nearest] positioned ^ ^ ^0.015625 run tp 4fe002bb-0-0-0-3 ~ ~ ~

## 座標の計算
# データの取得
execute if data entity @s {billboard:"center"} at @s rotated as @p facing ^ ^ ^-1 run tp @s ~ ~ ~ ~ ~
data modify storage _: Pos1 set from entity 4fe002bb-0-0-0-3 Pos
...
execute if score #X _ matches -350..400 if score #Y _ matches 385..660 on passengers if entity @s[tag=display_11] run data modify entity @s background set value 1090453504
execute if score #X _ matches -870..-100 if score #Y _ matches 1..270 on passengers if entity @s[tag=display_21] run data modify entity @s background set value 1090453504
execute if score #X _ matches 125..900 if score #Y _ matches 1..270 on passengers if entity @s[tag=display_31] run data modify entity @s background set value 1090453504