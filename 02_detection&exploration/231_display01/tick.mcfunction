...
execute if data entity @s {billboard:"fixed"} at @p as @e[tag=display01_pos,limit=1,sort=nearest] positioned as @s run tp @s ~ ~ ~ ~ ~ 
execute if data entity @s {billboard:"fixed"} at @p as @e[tag=display01_pos,limit=1,sort=furthest] positioned as @s facing ^ ^ ^-1 run tp @s ~ ~ ~ ~ ~ 
...
# 二分探査
execute as @p anchored eyes at @p rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^16 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^8 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^4 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^2 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^1 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^0.5 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^0.25 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^0.125 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^0.0625 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^0.03125 rotated as @e[tag=display01_pos,limit=1,sort=nearest] positioned ^ ^ ^0.015625 run tp @e[tag=display01_marker,limit=1] ~ ~ ~
...
execute store result score #sin1 _ run data get storage _: Tls.left_rotation[0] 10000
execute store result score #cos1 _ run data get storage _: Tls.left_rotation[3] 10000
execute store result score #sin2 _ run data get storage _: Tls.right_rotation[0] 10000
execute store result score #cos2 _ run data get storage _: Tls.right_rotation[3] 10000
...
scoreboard players operation #xsin _ /= #10000 _
scoreboard players operation #zcos _ *= #sin2 _
scoreboard players operation #zcos _ /= #10000 _
...
scoreboard players operation #X _ /= #10000 _
scoreboard players operation #Y _ /= #10000 _
