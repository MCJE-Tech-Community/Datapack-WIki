...
## 座標の計算
# データの取得
execute if data entity @s {billboard:"fixed"} at @s positioned ^ ^ ^-100 as @e[tag=display01_marker,limit=1] facing entity @s feet positioned as @s run tp @s ~ ~ ~ ~ ~
execute if data entity @s {billboard:"center"} at @s rotated as @p positioned ^ ^ ^-100 as @e[tag=display01_marker,limit=1] facing entity @s feet positioned as @s run tp @s ~ ~ ~ ~ ~
# Rotationの取得
data modify storage _: Rot1 set from entity @e[tag=display01_marker,limit=1] Rotation
execute if data entity @s {billboard:"fixed"} run data modify storage _: Rot2 set from entity @s Rotation
execute if data entity @s {billboard:"center"} run data modify storage _: Rot2 set from entity @p Rotation
# 角度差の計算
...
execute if data entity @s {billboard:"center"} run scoreboard players operation #x _ *= #-1 _
